...
def readmcap(mcap_path, config_path, output_path):
    ...
    T0 = T_b_c0[:3]
    T1 = T_b_c1[:3]
    distortion0 = list(msg_cam0.D)
    distortion1 = list(msg_cam1.D)
    write_instrinsic_parameters(
        "./camera_parameters/c0.dat",
        K0,
        distortion0,
        distortion_model=msg_cam0.distortion_model,
    )
    write_instrinsic_parameters(
        "./camera_parameters/c1.dat",
        K1,
        distortion1,
        distortion_model=msg_cam1.distortion_model,
    )
